...
class InsertHistoryUseCase @Inject constructor(private val barCodeResultRepository: BarCodeResultRepository) {
  suspend operator fun invoke(barcodeResult: BarCodeResult) = barCodeResultRepository.insertHistory(barcodeResult)
}
