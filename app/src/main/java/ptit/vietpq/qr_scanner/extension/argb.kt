...
private fun Int.toHex(): String = Integer.toHexString(this).let {
  if (it.length == 1) {
    "0$it"
  } else {
    it
...
internal fun Double.lighten(lightness: Float): Double = this + (255 - this) * lightness

internal fun Float.lighten(lightness: Float): Float = this + (255 - this) * lightness

internal fun Int.lighten(lightness: Float): Int = (this + (255 - this) * lightness).roundToInt()
