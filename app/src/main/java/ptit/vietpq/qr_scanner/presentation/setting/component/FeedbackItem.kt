...
@Preview
@Composable
private fun FeedbackItemPreview() {
  FeedbackItem()
}
  ...
  Column(modifier = modifier) {
    Row(
      ...
      Column(
        ...
        Text(text = QrLocale.strings.feedBack, style = QrCodeTheme.typo.subTitle, color = QrCodeTheme.color.neutral1)
        Text(
          text = QrLocale.strings.feedBackDescription,
